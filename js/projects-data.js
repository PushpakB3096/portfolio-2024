const projectsData = {
    ...
    "food-delivery-app": {
        ...
        overview: "A modern food delivery application that connects users with local restaurants. Features include real-time order tracking, secure payments, and an intuitive user interface.",
        features: [
    ...
    "portfolio-website": {
        ...
        overview: "A personal portfolio website showcasing projects and skills. Built with modern web technologies and features smooth animations and responsive design.",
        features: [
            "Responsive design",
            "Smooth animations",
            "Project showcase",
